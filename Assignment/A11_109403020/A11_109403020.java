...
public class A11_109403020 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Timeline timeline = new Timeline(
        		new KeyFrame(Duration.ZERO, new KeyValue(rotation.angleProperty(), 0), new KeyValue(arc.opacityProperty(), 1)),
                new KeyFrame(Duration.seconds(1), new KeyValue(rotation.angleProperty(), 360), new KeyValue(arc.opacityProperty(), 0)),
                new KeyFrame(Duration.seconds(6), new KeyValue(rotation.angleProperty(), 720), new KeyValue(arc.opacityProperty(), 1))
        				); 
         //重複無限多次
